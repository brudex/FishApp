...
public class FishHealthOutputActivity extends AppCompatActivity  implements SeekBar.OnSeekBarChangeListener,
        OnChartGestureListener, OnChartValueSelectedListener
{
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        List<GraphChart> chartList = GraphService.getFishHealthGraph("","");

        for (int k = 0; k < chartList.size(); k++) {
            LineDataSet d = chartList.get(k).getLineDataSets(k);
            List<Entry> values = chartList.get(k).getLineEntries();
            d.setValues(values);
            d.setLineWidth(2.5f);
