...
{
    RelativeLayout ponds, econ_indicator, fish_health, pdata,productionUnitDash,economicIndicatorDash;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        economicIndicatorDash.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), FishHealthOutputActivity.class)));
